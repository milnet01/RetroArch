      ...
      bool is_threaded, const char *dir_assets, char *font_path)
{
   ...
   p_dispwidget->simple_widget_padding            = (unsigned)VIDEO_PX(p_dispwidget->gfx_widget_fonts.regular.line_height * (2.0f / 3.0f));
   ...
   p_dispwidget->msg_queue_padding                = (unsigned)VIDEO_PX((float)p_dispwidget->gfx_widget_fonts.msg_queue.line_height * (2.0f / 3.0f));
   ...
   if (p_dispwidget->last_scale_factor > 1.0f)
      p_dispwidget->divider_width_1px             = (unsigned)VIDEO_PX(p_dispwidget->last_scale_factor);
